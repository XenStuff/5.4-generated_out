deps_config := \
	...
	drivers/input/touchscreen/focaltech_nothing/Kconfig \
...
ifneq "$(srctree)" "/home/rayan/p/kernel/msm-5.4"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "Android (11039501, +pgo, +bolt, +lto, +mlgo, based on r498229b) clang version 17.0.4 (https://android.googlesource.com/toolchain/llvm-project e34ed7d63863b45858e74126edaa738e75887800)"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "llvm-nm"
include/config/auto.conf: FORCE
...
ifneq "$(HOSTCC)" "/home/rayan/p/prebuilts/clang/host/linux-x86/clang-r498229b/bin/clang"
include/config/auto.conf: FORCE
endif
